...
const Demographics2 = ({navigation}) => {
  ...
  const [items3, setItems3] = useState([
    ...
    {
      label: 'Pregnancy or recent pregnancy',
      value: 'Pregnancy or recent pregnancy',
    },
    {
      label: 'Smoking (current and former)',
      value: 'Smoking (current and former)',
    },
    {
      label: 'Solid organ or blood stem cell transplantation',
      value: 'Solid organ or blood stem cell transplantation',
    },
    {
      label: 'Use of corticosteroids or other immunosuppressive medications',
      value: 'Use of corticosteroids or other immunosuppressive medications',
    },
  ]);
    ...
    if (toggleCheckBox == false) {
      if (
        ...
        const body = {
          ...
          regular_doctors_appointments: drop7,
        };
        dispatch({
          type: FORMTHREE,
          payload: body,
