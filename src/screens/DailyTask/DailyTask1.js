    ...
    <View style={{flex:1,backgroundColor:Colors.white}}>
      ...
      <TouchableOpacity onPress={() => navigation.goBack()}>
          ...
          <View style={{marginHorizontal:'28%'}}>
            <Text style={{color:Colors.purple,fontWeight:'bold',fontSize:18}}>Daily Task</Text>
          </View>
        </View>
      ...
      {activeTab === 'tasks' && (
        <View style={styles.tabContent}>
           <ScrollView style={{maxHeight:'100%'}} contentContainerStyle={{paddingBottom:20}}
...
<View style={{flexDirection:'row'}}>
                 ...
                 <View style={{backgroundColor:'white',height:'109%',width:15,position:'absolute',marginTop:20,borderTopRightRadius:50,borderBottomRightRadius:50}} /> 
...
<Text style={styles.doneButtonText}>Done</Text>
           ...
           <View style={{borderBottomWidth:0.2,borderTopWidth:0.2,borderLeftWidth:0.2,borderRightWidth:0.2,borderTopLeftRadius:8,borderBottomLeftRadius:8,borderTopColor:'lightgrey',borderLeftColor:'lightgrey',borderBottomColor:'lightgrey',marginTop:20,backgroundColor:'white',width:'100%',borderRightColor:'lightgrey',elevation:5}}>
               <View style={{padding:15,marginTop:10,marginBottom:10,}}>
                   <Text style={{color:'black',fontWeight:'bold',fontSize:16,letterSpacing:1,}}>DAILY TASK TITLE</Text>
...
<Text style={styles.doneButtonText}>Done</Text>
          ...
          >
            {/* Survey item content */}
            <TouchableOpacity onPress={() => navigation.navigate('Question1')}>
        <View style={{height:110,alignItems:'center',flexDirection:'row',borderBottomWidth:0.2,borderTopWidth:0.2,borderLeftWidth:0.2,borderRightWidth:0.2,borderTopLeftRadius:8,borderBottomLeftRadius:8,borderTopColor:'lightgrey',borderLeftColor:'lightgrey',borderBottomColor:'lightgrey',marginTop:20,backgroundColor:'white',width:'100%',borderRightColor:'lightgrey',elevation:5}}>
            ...
            <View style={{marginLeft:10,width:'75%'}}>
                ...
                <Text style={{color:'black',fontWeight:'bold',fontSize:16,letterSpacing:1,}}>DAILY TASK TITLE</Text>
                <Text style={{fontSize:12.5}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt..</Text>
            </View>
        </View>
        </TouchableOpacity>
          </Swipeable>
...
<View style={{}}>
        <Text style={{color:'white',fontWeight:'bold',fontSize:12,textAlign:'center'}}>Task successfully completed</Text>
