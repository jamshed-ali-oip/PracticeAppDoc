...
onComplete();
  ...
  return (
    <View style={{ flex: 1,}}>
      ...
      <View style={{}}>
        <Text style={{color:Colors.purple,fontWeight:'bold',fontSize:20,textAlign:'center',marginLeft:'40%'}}>Support</Text>
      </View>
      </View>
      ...
      <View style={{}}>
        <Text style={{color:Colors.darkGray,fontSize:15,marginTop:10}}>Tell us as much as you can about the problem , and we'll make sure to get you to the right person</Text>
       
      </View>
      <View style={{marginTop:20,}}><Text style={{fontSize:18,fontWeight:'bold',color:Colors.purple}}>Message</Text></View>
      <View style={{width:'94%',height:300,borderWidth:1,borderColor:'grey',marginTop:10}}>

      <TextInput
            style={{fontSize: 14, color: 'black',  marginTop: 5}}
            placeholder="hi i need some one help with"
      ...
      <View style ={{flexDirection:'row',alignItems:'center',marginLeft:0,marginTop:30}}>
  ...
  />
        <TouchableOpacity>
        <Text style={{color:'black',fontSize:14}}>Disclaimer Terms</Text>
        </TouchableOpacity>
        </View>
        <View style={{width:'94%',marginHorizontal:10,}}>
        <Text style={{fontSize:14,color:Colors.darkGray}}>By Submitting this form you acknowlege and understood the limitations and conditions mentioned above . Thank you for you cooperation</Text>
        </View>
