...
const Question10LES = ({navigation}) => {
  ...
  return (
    ...
    <View style={{ flex: 1,}}>
      ...
      <Text style={{color:Colors.purple,fontWeight:'bold',fontSize:20,}}>(Q-LES-Q-SF)</Text>
        <Text style={{color:Colors.purple,fontWeight:'bold',fontSize:20,marginTop:20}}>Question 10/15</Text>
...
/>
      ...
      >
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("Question11LES")}
        >
          <View >
