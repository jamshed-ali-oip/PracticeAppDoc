  ...
  return (
    ...
    <View style={{ flex: 1,}}>
      ...
      <Text style={{color:Colors.purple,fontWeight:'bold',fontSize:20,}}>(Q-LES-Q-SF)</Text>
        <Text style={{color:Colors.purple,fontWeight:'bold',fontSize:20,marginTop:20}}>Question 1/15</Text>
      ...
      <View style={{marginTop:15,marginLeft:20,width:'90%'}}>
        ...
        <Text style={{fontSize:15.5,fontWeight:'600',marginTop:20,color:'black',}}>Physical Health?</Text>
      </View>
...
/>
      ...
      >
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("Question2LES")}
        >
          <View >
