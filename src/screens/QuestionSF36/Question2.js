    ...
    const data = [
        {
         ...
         },
         {
           ...
           {
            label: 'Much worse now than one year ago'
           }
  ...
  return (
    <View style={{ flex: 1,}}>
      ...
      <View style={{marginTop:15,}}>
        <Text style={{color:Colors.purple,fontWeight:'bold',fontSize:20,}}>Question 2/11</Text>
        <Text style={{fontSize:18,fontWeight:'600',marginTop:20,color:'black'}}>Compared to one year ago,</Text>
      </View>
