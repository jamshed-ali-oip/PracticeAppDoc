  ...
  return (
    ...
    <View style={{ flex: 1,}}>
      ...
      <View style={{marginTop:15,marginLeft:20,width:'90%'}}>
        <Text style={{color:Colors.purple,fontWeight:'bold',fontSize:20,}}>Question 6/11</Text>
        <Text style={{fontSize:15.5,fontWeight:'600',marginTop:20,color:'black',}}>During the past 4 weeks, to what extent has your physical health or emotional problems interfered with your normal social activities with family, friends, neighbors, or groups?</Text>
      </View>
...
/>
      ...
      >
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("Question7")}
        >
          <View >
