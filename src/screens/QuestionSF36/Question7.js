  ...
  return (
    ...
    <View style={{ flex: 1,}}>
      ...
      <View style={{marginTop:15,marginLeft:20,width:'90%'}}>
        <Text style={{color:Colors.purple,fontWeight:'bold',fontSize:20,}}>Question 7/11</Text>
        <Text style={{fontSize:15.5,fontWeight:'600',marginTop:20,color:'black',}}>How much bodily pain have you had during past 4 weeks?</Text>
      </View>
