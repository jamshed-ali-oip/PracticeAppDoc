  ...
  return (
    ...
    <View style={{ flex: 1,}}>
      ...
      <View style={{marginTop:15,marginLeft:20,width:'90%'}}>
        <Text style={{color:Colors.purple,fontWeight:'bold',fontSize:20,}}>Question 8/11</Text>
        <Text style={{fontSize:15.5,fontWeight:'600',marginTop:20,color:'black',}}>During the past 4 weeks, how much did pain interfere with your normal work (including both work outside the home and housework)?</Text>
      </View>
