...
const Question2SR = ({navigation}) => {
  ...
  const [items, setItems] = useState([
    {label: 'I do not wake up at night', value: 'I do not wake up at night'},
    {label: 'I have a restless, light sleep with a few brief awakenings each night.', value: 'I have a restless, light sleep with a few brief awakenings each night.'},
  ...
  return (
    ...
    <View style={{ flex: 1,}}>
      ...
      <Text style={{color:Colors.purple,fontWeight:'bold',fontSize:20,}}>Quick Inventory of Depressive Symptomatology (QIDS-SR)</Text>
        <Text style={{color:Colors.purple,fontWeight:'bold',fontSize:20,marginTop:20}}>Question 2/16</Text>
      ...
      <View style={{marginTop:15,marginLeft:20,width:'90%'}}>
        ...
        <Text style={{fontSize:15.5,fontWeight:'600',marginTop:20,color:'black',}}>Sleep During the Night:</Text>
      </View>
...
/>
      ...
      >
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("Question3SR")}
        >
          <View >
